...
public class D_myDiary extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpannableString title = new SpannableString(valueOf(data.Title));
        //title.setSpan(new UnderlineSpan(), 0, title.length(), 0);
        diary_title.setText("제목: "+title);

        //SpannableString content2 = new SpannableString(valueOf(data.Weather));
        //content2.setSpan(new UnderlineSpan(), 0, content2.length(), 0);
        String weather = valueOf(data.Weather);
        diary_weather.setText("날씨: "+weather);
